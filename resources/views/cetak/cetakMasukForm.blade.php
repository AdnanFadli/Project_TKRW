...
@section('content')
    <h3 align="center">LAPORAN KAS MASUK PERTANGGAL</h3>
    <div class="card">
        <h1></h1>
        <div class="card-body">
            <div class="col">
        ...
        <div class="text-center">
            <a onclick="this.href='cetakMasukPertanggal/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value"
